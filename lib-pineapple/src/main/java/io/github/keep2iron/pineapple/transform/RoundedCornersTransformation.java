...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    public RoundedCornersTransformation(int radius, int margin) {
        this(radius, margin, 0, 0, CornerType.ALL);
    }

    public RoundedCornersTransformation(int radius, int margin, int borderSize, @ColorInt int borderColor, CornerType cornerType) {
        this.radius = radius;
